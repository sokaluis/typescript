...
var concatenar =
  'Los héroes son:' + batman + ', ' + linternaVerde + volcanNegro;
var concat =
  'Los h\u00E9roes son: ' + batman + ', ' + linternaVerde + ', ' + volcanNegro;
...
var captain_america = {
  ...
  order: function () {
    var _this = this;
    setTimeout(function () {
      return console.log(_this.name + ' smaaaash!!!');
    }, 1000);
  },
};
...
var warmachine = avengers1.ironman,
  nick = avengers1.nick,
  vision = avengers1.vision;
...
var spiderman2099 = versiones[0],
  spidergirl = versiones[1],
  ultimate = versiones[2];
var villanos12 = {
  venom: 'Eddie Brock',
  carnage: 'Cletus Kasady',
  sandman: 'William Baker',
};
var spidermanBlack = villanos12.venom,
  carnage = villanos12.carnage,
  sandman = villanos12.sandman;
...
for (
  var _i = 0, avengersArray_1 = avengersArray;
  _i < avengersArray_1.length;
  _i++
) {
